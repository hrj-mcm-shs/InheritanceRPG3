package jugar.mcm.edu.ph.inheritancerpg3.classes.secondary.mercenary;

import jugar.mcm.edu.ph.inheritancerpg3.classes.primary.Mercenary;

public class Hacker extends Mercenary {
    public Hacker(int id, double health, double healthRegen, double fuel, double fuelCharge,
